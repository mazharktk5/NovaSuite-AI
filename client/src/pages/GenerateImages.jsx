...
//         <textarea onChange={(e) => setInput(e.target.value)} value={input} rows={4} className='w-full p-2 mt-2 outline-none text-sm rounded-md border border-gray-300' placeholder='Describe what you want to see in image .....' required />
...
const GenerateImages = () => {
  return (
    <div className='h-full w-full flex justify-center items-center p-6 text-center'>
      <div className='max-w-md p-8 bg-white border border-gray-200 rounded-lg shadow-sm'>
        <h1 className='text-2xl font-semibold text-gray-800 mb-4'>AI Image Generator</h1>
        <p className='text-gray-500 text-sm'>
          🚧 This feature is currently unavailable. We're working on it and will launch it soon. Stay tuned!
        </p>
      </div>
    </div>
  )
